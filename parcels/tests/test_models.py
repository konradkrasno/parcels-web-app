...
class AdvertTests(TestCase):
    ...
    def test_download_adverts_from_json(self, mock_file):
        ...
        self.assertEqual(Advert.objects.values("description")[0]["description"], data[0]["description"])
    ...
    def test_filter_adverts(self):
        filtered_adverts_1 = Advert.filter_adverts(place="Dębe Wielkie", price=400000, area=800).values("link")
        ...
        filtered_adverts_2 = Advert.filter_adverts(place="Rysie", price=200000, area=1000).values("link")
...
class FavouriteTests(TestCase):
    ...
    def test_add_to_favourite_first_time(self):
        ...
        self.assertDictEqual(Favourite.objects.values("user_id", "favourite")[0], expected_data)
    ...
    def test_add_to_favourite(self):
        ...
        self.assertDictEqual(Favourite.objects.filter(user_id=1).values("user_id", "favourite")[0], expected_data)
    ...
    def test_make_many_favourite(self):
        ...
        self.assertDictEqual(Favourite.objects.filter(user_id=1).values("user_id", "favourite")[0], expected_data_1)
        ...
        expected_data_2 = {
            'user_id': 1,
            'favourite': '1,2,3,4,5,6,7'
        }

        self.assertDictEqual(Favourite.objects.filter(user_id=1).values("user_id", "favourite")[0], expected_data_2)
    ...
    def test_remove_many_favourite_from_fav(self):
        actual_adverts_1 = Advert.objects.all()

        Favourite.remove_many_favourite_from_fav(user_id=1, pk_list=[1, 2])
        ...
        Favourite.remove_many_favourite_from_fav(user_id=1, pk_list=[1, 2, 3, 4, 5])
        ...
        Favourite.remove_many_favourite_from_fav(user_id=1, pk_list=[6, 7])
